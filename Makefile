...
ALL_SERVICES = $(DOCKER_COMPOSE_PIP_COMPILER_FILE) $(DOCKER_COMPOSE_AMD_UNIT_TEST_FILE) $(DOCKER_COMPOSE_UNIT_TEST_FILE) $(DOCKER_COMPOSE_BUILD_APP_FILE) $(DOCKER_COMPOSE_AMD_RUN_APP_FILE) $(DOCKER_COMPOSE_RUN_APP_FILE)
